...
<div style="width:  500px;margin-left: 34%;">
  ...
  <div class="layui-form-item">
    ...
    <div class="layui-input-block">
      <input type="radio" name="user_type" value=0 title="管理员" disabled="disabled" <?php if($user["user_type"] == 0): ?>checked<?php endif; ?>>
      <input type="radio" name="user_type" value=1 title="审核员" disabled="disabled" <?php if($user["user_type"] == 1): ?>checked<?php endif; ?>>
      <input type="radio" name="user_type" value=2 title="员工" disabled="disabled" <?php if($user["user_type"] == 2): ?>checked<?php endif; ?>>
    </div>
  </div>
